...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  public @org.apache.thrift.annotation.Nullable String localDateTime; // required
  ...
  public Response setLocalDateTime(@org.apache.thrift.annotation.Nullable String localDateTime) {
    this.localDateTime = localDateTime;
    return this;
  }
  ...
  public int compareTo(Response other) {
    ...
    lastComparison = Boolean.compare(isSetLocalDateTime(), other.isSetLocalDateTime());
    if (lastComparison != 0) {
